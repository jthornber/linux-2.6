			  ...
			  struct bio *bio)
{
	...
	/*
	 * The copy can proceed in parallel with the quiescing of previous
	 * (read) io.  We don't check the return value of ds_add_work()
	 * since this is inferred by m->list being empty.
	 */
